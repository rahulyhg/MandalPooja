...
import com.spps.mandal.Connectivity.EditYaatraDetails;
...
public class EditYaatra extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_yaatra);

        SessionManager sessionManagerNgo = new SessionManager(EditYaatra.this);
        ...
        if (v.getId() == R.id.btnAddYaatra) {
            if (selectedDateForYatra == "" || selectedDateForPooja == "" || selectedDateForDarshan == "")  {
                ...
                try {
                    ...
                    EditYaatraDetails editYaatraDetails = new EditYaatraDetails(EditYaatra.this);
                    editYaatraDetails.editYaatraDetails(selectedDateForYatra,selectedDateForPooja, selectedDateForDarshan,userId,progressDialog);
...
//                .show();
    ...
    protected void onPause() {
        super.onPause();
        PackageManager pm = EditYaatra.this.getPackageManager();
        ComponentName component = new ComponentName(EditYaatra.this, NetworkChangeReceiver.class);
